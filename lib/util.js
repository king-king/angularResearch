...
(function () {
    ...
    function isElement(value) {
        return (/\[object HTML[a-zA-Z]*Element]/).test(Object.prototype.toString.call(value))
    }
    ...
    function element(tag, property, parent) {
        var el = isElement(tag) ? tag : document.createElement(tag);
        property && loopObj(property, function (key, value) {
            switch (key) {
                case "klass":
